...
public class PieDonutChartComponentBeanInfo extends CommonBeanInfo {
    ...
    protected void initProperties() throws IntrospectionException {
        ...
        addProp("holeSize", "Hole Size", "Center hole size percentage used when donut mode is selected.", CAT_BEHAVIOR, PREFERRED_MASK | BOUND_MASK);
        addProp("showLabels", "Show Labels", "Shows outer labels for pie/donut and ring labels for rings.", CAT_BEHAVIOR, PREFERRED_MASK | BOUND_MASK);
        addProp("showPercentages", "Show Percentages", "Shows percentages inside pie and donut slices.", CAT_BEHAVIOR, PREFERRED_MASK | BOUND_MASK);
        addProp("strokeWidth", "Stroke Width", "Ring stroke width used in rings mode.", CAT_BEHAVIOR, PREFERRED_MASK | BOUND_MASK);
        addProp("ringGap", "Ring Gap", "Gap in pixels between rings when rings mode is selected.", CAT_BEHAVIOR, PREFERRED_MASK | BOUND_MASK);
        addProp("chartTopGap", "Chart Top Gap", "Gap between the title/subtitle block and the chart.", CAT_BEHAVIOR, PREFERRED_MASK | BOUND_MASK);

        addProp("borderStroke", "Border Stroke", "Border stroke width.", CAT_BEHAVIOR, PREFERRED_MASK | BOUND_MASK);
        addProp("borderRadius", "Border Radius", "Border corner radius. 0 means square corners.", CAT_BEHAVIOR, PREFERRED_MASK | BOUND_MASK);

        addProp("data", "Data", "Dataset with columns value, label, and color.", CAT_DATA, PREFERRED_MASK | BOUND_MASK);
        addProp("selectedRow", "Selected Row", "Currently selected row index. Use -1 for no selection.", CAT_DATA, PREFERRED_MASK | BOUND_MASK);
        ...
        addProp("labelFont", "Label Font", "Font used for ring labels.", CAT_APPEARANCE, PREFERRED_MASK | BOUND_MASK);
        ...
        addProp("sliceValueFont", "Slice Value Font", "Font used for outer numeric values in pie/donut mode.", CAT_APPEARANCE, PREFERRED_MASK | BOUND_MASK);
        addProp("sliceLabelFont", "Slice Label Font", "Font used for outer labels in pie/donut mode.", CAT_APPEARANCE, PREFERRED_MASK | BOUND_MASK);
        ...
        addProp("labelColor", "Label Color", "Color used for ring labels.", CAT_APPEARANCE, PREFERRED_MASK | BOUND_MASK);
        ...
        addProp("sliceValueColor", "Slice Value Color", "Color used for outer numeric values in pie/donut mode.", CAT_APPEARANCE, PREFERRED_MASK | BOUND_MASK);
        addProp("sliceLabelColor", "Slice Label Color", "Color used for outer labels in pie/donut mode.", CAT_APPEARANCE, PREFERRED_MASK | BOUND_MASK);
    }
